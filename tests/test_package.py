...
with zipfile.ZipFile(sys.argv[1]) as package:
    ...
    assert manager['Version'] == 1 and manager['Name'] == 'Bingus Shared Loader - v15'
    ...
    assert report['revision'] == 'loader-v15' and report['provides'] == {'shared_loader_api': 1, 'addon_discovery': 1}
